...
HEMUL depends on some external libraries written in a "shared way". I.e.
...
already build and installed, and assumes it's in source in form of links to
...
1) Get the source 
2) preferably place it side-by-side with HEMUL 
